...
// Removed adminNotificationAPI import for B2C model
...
const AdminDashboard = () => {
  ...
  // Load admin notifications - simplified for B2C
  const loadNotifications = async () => {
    try {
      // Mock notifications for B2C
      setNotifications([]);
    } catch (error) {
  ...
  // Verification functions removed for B2C model
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      {tabValue === 0 && (
        <Box>
          ...
          <Typography variant="body1">Welcome to TechCycle Admin Dashboard</Typography>
